          ...
          <tr>
			...
			<thead>
              <tr class="logintext">
                ...
                <th width="21%"colspan="2" align="center" valign="middle" bgcolor="#99CC99" class="pedtext" >
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
				...
				<td width="18%" align="center" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[first_name];?> <?php echo $Arabic->en2ar($dbf->StudentName($val["id"]));?> <?php echo " [".$num_dtls."]";?></td>
