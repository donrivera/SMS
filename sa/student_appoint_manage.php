          ...
          <tr>
              ...
              <tr>
                <td width="35%" height="22" align="center" valign="middle"><table width="99%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="5%" align="left" valign="middle" bgcolor="#FF0000">&nbsp;</td>
                    <td width="39%" align="left" valign="middle" class="mycon">&nbsp;Appointment Pending</td>
                    <td width="5%" align="left" valign="middle" bgcolor="#3366FF">&nbsp;</td>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
              ...
              <tr class="logintext">
			    ...
			    <th width="21%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("RECEPTION_S_MANAGE_STUDENTNAME");?></th>
				<th width="48%" align="left" valign="middle" bgcolor="#99CC99" class="pedtext" ><?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_COMMENT");?></th>
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" >
                ...
                <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[dated];?></td>
				  <td height="25" align="left" valign="middle" class="mycon" style="padding-left:5px;"><a href="single-home.php?student_id=<?php echo $res[id];?>" style="cursor:pointer;"><?php echo $res[first_name];?><?php echo $Arabic->en2ar($dbf->StudentName($res["id"]));?></a></td>
				    <td height="25" align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[comments];?></td>
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="right" valign="middle"><input type="submit" value="Search" class="btn_no" border="0" align="left" /></td>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#000000" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
              ...
              <tr class="logintext">
			    ...
			    <th width="16%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_S_MANAGE_STUDENTNAME");?></th>
				<th width="48%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_COMMENT");?></th>
                
                <th width="14%" align="right" valign="middle" bgcolor="#99CC99" class="pedtext" style="padding-right:25px;"><?php echo constant("RECEPTION_STUDENT_APPOINT_MANAGE_DATE");?> </th>
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='student_appoint_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                <td width="4%" align="center" valign="middle"><?php if($val["status"]==0) { ?>
				      ...
				      <a href="student_appoint_process.php?action=unblock&amp;id=<?php echo $val[id];?>"><img src="../images/block.png" width="16" height="16" border="0" title="Click to Active the User." /></a>
				      <?php } ?></td>
				    <td width="5%" align="center" valign="middle"><a href="student_appoint_edit.php?id=<?php echo $val[id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a></td>
				...
				<td height="25" align="right" valign="middle" class="mycon" style="padding-left:5px;">
				<?php echo $res[first_name];?><?php echo $Arabic->en2ar($dbf->StudentName($res["id"]));?></td>
				<td height="25" align="right" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $val[comments];?></td>				    
