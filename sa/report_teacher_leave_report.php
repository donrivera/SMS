		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                <td width="21%" height="30" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHERLEAVE");?></td>
                      ...
                      <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
					   ...
					   ?>
                          ...
                          <td width="9%" align="left" valign="middle" class="logintext"> :&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHER");?> </td>
                           <td width="19%" height="30" align="right" class="headingtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHERLEAVE");?><img src="../images/arrow_small_right2.png" width="16" height="16"></td>
                          </tr>
                        </table></td>
                      </tr>
                    <tr>
