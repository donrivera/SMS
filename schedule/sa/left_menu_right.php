...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	?>
      <tr>
        <td  style="border-left:solid 2px; border-color:#CCC;" align="right" valign="middle"><span class="<?php echo $class;?>"><a style="text-decoration:none;" href="<?php echo $val_quick[links];?>"><?php echo constant($linkname);?></a>&nbsp;</span></td>
