      ...
      <?php if($_REQUEST['msg'] == 'block'){?>
        ...
        <tr>
          ...
          <td colspan="2" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="25%" align="right" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;">Student Name :</td>
              <td width="2%">&nbsp;</td>
            ...
            <tr>
              <td align="right" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;">Mobile No :</td>
              <td>&nbsp;</td>
            ...
            <tr>
              <td align="right" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;">&nbsp;</td>
              <td>&nbsp;</td>
              <td align="left" valign="middle">&nbsp;</td>
            </tr>
            <tr>
              <td align="right" valign="top" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;">Message :&nbsp;</td>
              <td>&nbsp;</td>
              <td align="left" valign="middle">
                <textarea name="msg" id="msg" rows="3" cols="30" style="border:solid 1px; background-color:#ECF1FF; border-color:#999999;"></textarea>
              </td>
            </tr>
            <tr>
              <td height="5" colspan="3" align="right" valign="middle"></td>
          ...
          <tr>
            <td height="30" colspan="2" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; color:#003333; font-weight:normal; font-size:12px;">: <?php echo $Arabic->en2ar('Mobile No');?></td>
              </tr>
              <tr>
              ...
              <tr>
                <td align="right" valign="middle"><textarea name="msg" id="msg" rows="3" cols="30" style="border:solid 1px; text-align:right; background-color:#ECF1FF; border-color:#999999;"></textarea></td>
                <td>&nbsp;</td>
