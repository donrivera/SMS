...
<table width="400" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc; margin-top:-15px;">
  <tr>
    <td height="45" colspan="4" align="right" valign="middle" bgcolor="#CCCCCC" class="headingtext">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_GREGORIANTOHIJRI");?></td>
  </tr>
  <tr>
    <td width="28">&nbsp;</td>
    <td width="78" align="left" valign="middle" class="bigerrortext">&nbsp;</td>
