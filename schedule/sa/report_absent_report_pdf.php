...
$htmlFile = $baseUrl."report_absent_report_pdf_data.php?fname=$_REQUEST[fname]&stid=$_REQUEST[stid]&mobile=$_REQUEST[mobile]&email=$_REQUEST[email]&centre_id=$_SESSION[centre_id]";
