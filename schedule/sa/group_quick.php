                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="71%" align="left" valign="middle">
                                  <select name="course" class="validate[required]" id="course" style="width:150px; border:solid 1px; border-color:#999999;" onChange="show_students();">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="middle"><input type="text" name="gr_course_endt" class="validate[required] new_textbox80"  id="gr_course_endt" value="" readonly="" />&nbsp;<input type="text" name="dt" class="validate[required] new_textbox80" id="dt" readonly="" value="">&nbsp;<input type="text" name="tm" class="new_textbox70" id="tm" readonly="" value=""></td>
                                </tr>
                              </table>
                            </td>
                            <td>&nbsp;</td>
                                          ...
                                          <td height="28" colspan="2" align="right" valign="top" class="leftmenu">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                ...
                                                <td align="right" valign="middle"><input type="text" name="gr_course_endt" class="validate[required] new_textbox80"  id="gr_course_endt" value="" readonly="" />&nbsp;<input type="text" name="dt" class="new_textbox80" id="dt" readonly="" value="">&nbsp;<input type="text" name="tm" class="new_textbox70" id="tm" readonly="" value=""></td>
