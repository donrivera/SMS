			...
			<table width="100%" border="1" cellpadding="0" bordercolor="#000000" cellspacing="0" class="tablesorter" id="sort_table" style="border-collapse:collapse;">
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='s_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                ...
                <td width="3%" align="center" valign="middle" ><a href="search_manage.php?id=<?php echo $val[id];?>">
                  <?php if($num_group > 0) { ?>
                  <img src="../images/additional.png"  border="0" title="<?php echo ICON_DOLLAR ?>">
                  <?php } else { ?>
                  <img src="../images/ex-btn.png" width="16" height="16" border="0" title="<?php echo ICON_ADVANCE ?>">
                  <?php } ?>
                </a></td>
                <td width="3%" align="center" valign="middle" ><?php if($num_comment!=0){?>
                  <a href="view_student_comments_history_from_manage.php?ids=<?php echo $val["id"]; ?>"><img src="../images/comments.png" width="20" height="20" border="0" title="<?php echo VIEW_COMMENTS ?>"></a>
                  <?php }else {?>
            ...
            <tr>
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			        ...
			        ?>
                      <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" onClick="javascript:window.location.href='s_edit.php?id=<?php echo $val[id];?>'" style="cursor:pointer;">
                        ...
                        <td width="4%" align="center" valign="middle" ><?php if($num_comment!=0){?>
                          ...
                          <img src="../images/comments-no.png" title="<?php echo ICON_NO_COMMENTS ?>" />
                          <?php } ?></td>
                        <td width="4%" align="center" valign="middle" ><a href="s_edit.php?id=<?php echo $val["id"];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="<?php echo EDIT?>" /></a></td>
                        <td width="4%" align="center" valign="middle" ><a href="authonication.php?student_id=<?php echo $val["id"];?>" onClick="javascript:openWindow(this.href);return false;" ><img src="../images/home.png" width="16" height="16" border="0" title="<?php echo ICON_STUDENT_HOME ?>"></a></td>
                        <td align="left" valign="middle" class="mycon" style="padding-left:5px;"><?php echo $moving["name"];?></td>
                ...
                <?php
					...
					?>
                <tr>
                  <td height="25" colspan="9" align="center" valign="middle" class="nametext1"><?php echo ADMIN_GROUP_MANAGE_NOREC?> </td>
                  </tr>
                <?php
					}
					?>
