                        ...
                        <tr>
                          ...
                          <table width="90%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              ...
                              <select name="course" id="course" style="width:180px; border:solid 1px; border-color:#999999;background-color:#ECF1FF;" onChange="show_payment();">
                        ...
                        <tr>
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#EBEBEB">
                            <tr>
                              ...
                              <td width="24%" height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_SEARCH_MANAGE_LEVELCOMPL");?> :</td>
                              <td width="1%">&nbsp;</td>
                            ...
                            <tr>
                              ...
                              <td>&nbsp;</td>
                              <td align="left" valign="middle" ><input name="course_fee" type="text" class="new_textbox100" id="course_fee" value="<?php echo $course_fee;?>" readonly="readonly" />
                                &nbsp;<?php echo $res_currency[symbol];?></td>
                              <td>&nbsp;</td>
                            </tr>
                            <tr>
                              <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                              ...
                              <td colspan="2" rowspan="4" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td width="5%" align="left" valign="middle" class="mycon"><?php echo $res_currency[symbol];?></td>
                                  <td width="25%" align="left" valign="middle">&nbsp;</td>
                                  <td width="56%" rowspan="4" align="left" valign="top"><table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
                                    <?php			 
                            ...
                            <tr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="24%" align="right" valign="middle" class="leftmenu"><?php echo constant("NOTE_FOR_INVOICE");?> : &nbsp;</td>
                                  <td width="75%" align="left" valign="middle"><input name="note" class="new_textbox690" type="text" id="note" value="<?php echo $res_enroll["invoice_note"];?>" /></td>
                                </tr>
                              </table></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td height="18" colspan="4" align="left" valign="top" class="leftmenu"><table width="98%" border="2" bordercolor="#AAAAAA" cellspacing="0" cellpadding="0" style="border-collapse:collapse;">
                                <tr>
                                  ...
                                  <td colspan="2" align="center" valign="middle" bgcolor="#CDCDCD" class="pedtext">
                                ...
                                <tr>
                                  ...
                                  if($vali["paid_amt"]!="0") {
								  	...
								  	if($num_complete == 0) {
								  ?>
                                    <a href="search_invoice_edit.php?student_id=<?php echo $student_id;?>&amp;schid=<?php echo $vali["id"];?>&amp;course_id=<?php echo $_REQUEST[course_id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="Edit" /></a>
                                    <?php }} ?></td>
                                  ...
                                  <td height="25" colspan="4" align="center" valign="middle"><div id="div1"> </div>
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="53%" align="left" valign="middle"><input name="pdate1" type="text" class="datepick new_textbox100" id="pdate1" readonly="readonly" size="45" minlength="4"/></td>
                                          ...
                                          <td width="12%" align="center">&nbsp;<?php echo $res_currency[symbol];?></td>
                                        </tr>
                                      </table>
                                    </div>
                                    <div id="div2"> </div>
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="53%" align="left" valign="middle"><input name="pdate2" type="text" class="datepick new_textbox100" id="pdate2" readonly="readonly" size="45" minlength="4"/></td>
                                    ...
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="53%" align="left" valign="middle"><input name="pdate3" type="text" class="datepick new_textbox100" id="pdate3" readonly="readonly" size="45" minlength="4"/></td>
                                    ...
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="53%" align="left" valign="middle"><input name="pdate4" type="text" class="datepick new_textbox100" id="pdate4" size="45" readonly="readonly" minlength="4"/></td>
                                    ...
                                    <div style="clear:both;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="53%" align="left" valign="middle"><input name="pdate5" type="text" class="datepick new_textbox100" id="pdate5" size="45" readonly="readonly" minlength="4"/></td>
                                    ...
                                    <div id="div<?php echo $i;?>" style="display:none;">
                                      <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                        <tr>
                                          <td width="5%">&nbsp;</td>
                                          <td width="53%" align="left" valign="middle"><input name="pdate<?php echo $i;?>" type="text" class="datepick new_textbox100" readonly="readonly" id="pdate<?php echo $i;?>" size="45" minlength="4"/></td>
                                  ...
                                  <tr>
                                    ...
                                    <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        ...
                                        <table width="90%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td width="85%" height="30" align="right" valign="middle"><select name="course" id="course" style="width:180px; border:solid 1px; border-color:#999999;background-color:#ECF1FF;" onChange="show_payment();">
                    		...
                    		if($vali["paid_amt"]=="0") {
								  ...
								  ?>
                                    ...
                                    <?php
								  	...
								  	if($num_complete == 0) {
								  	?>
                                    <a href="search_invoice_edit.php?ids=<?php echo $student_id;?>&amp;schid=<?php echo $vali["id"];?>&amp;course_id=<?php echo $_REQUEST[course_id];?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="<?php echo EDIT?>" /></a>
                                    <?php }} ?></td>
                                    <td align="center" >
                                    <?php
										  //Check course_fees amount = paid amt
                                              ...
                                              <td height="25" colspan="4" align="center" valign="middle"><div id="div1"> </div>
                                                <div style="clear:both;">
                                                  <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                    <tr>
                                                      <td width="5%">&nbsp;</td>
                                                      <td width="53%" align="left" valign="middle"><input name="pdate1" type="text" class="datepick new_textbox100_ar" id="pdate1" readonly="readonly" size="45" minlength="4"/></td>
                                                ...
                                                <div style="clear:both;">
                                                  <table width="100%" border="0" cellspacing="2" cellpadding="0">
                                                    <tr>
                                                      <td width="5%">&nbsp;</td>
                                                      <td width="53%" align="left" valign="middle"><input name="pdate2" type="text" class="datepick new_textbox100_ar" id="pdate2" readonly="readonly" size="45" minlength="4"/></td>
