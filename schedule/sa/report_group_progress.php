    ...
    <table width="1000" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
		  ...
		  ?>
          <tr>
            <td height="20" align="right" valign="middle" class="shop2"><?php echo $res_g[group_name];?> <?php echo $res_g["group_time"];?>-<?php echo $dbf->GetGroupTime($res_g["id"]);?>&nbsp;</td>
          ...
          <tr>
            <td height="20" align="right" valign="middle" class="shop2"><?php if($res_g[start_date]!='0000-00-00') { echo date("d/m/Y",strtotime($res_g[start_date]));}?>&nbsp;</td>
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="59%" align="right" valign="middle" class="shop2" ><?php if($res_g[end_date]!='0000-00-00') {echo date("d/m/Y",strtotime($res_g[end_date]));}?>&nbsp;</td>
                <td width="41%" height="20" align="left" valign="middle" class="leftmenu">: <?php echo constant("ADMIN_VACATION_CENTRE_MANAGE_ENDDATE");?></td>
                </tr>
              </table></td>
            <td>&nbsp;</td>
