		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                <td width="23%" height="30" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHERLEAVE");?></td>
                <td width="6%" align="right" valign="middle" class="headingtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHER");?> :&nbsp; </td>
                ...
                <td width="5%" align="right"><span class="headingtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_FROM");?></span> :&nbsp; </td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                          <td width="3%" align="left">&nbsp;</td>
                          <td width="24%" align="left"><table width="240" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                          ...
                          <td width="14%" align="left"> :&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TO");?> </td>
					   ...
					   ?>
                          ...
                          <td width="6%" align="left" valign="middle" class="headingtext"> :&nbsp;<?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHER");?> </td>
                           <td width="23%" height="30" align="right" class="headingtext"><img src="../images/arrow_small_right4.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?> <img src="../images/arrow_small_right2.png" width="16" height="16"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHERLEAVE");?></td>
                          </tr>
                        </table></td>
                      </tr>
                    <tr>
