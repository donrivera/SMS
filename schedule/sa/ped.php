            ...
            <tr>
              ...
              <td width="23%" align="center">
                ...
                <table width="30%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="36" align="center" valign="middle"><a href="ped_word.php?cmbgroup=<?php echo $_REQUEST[cmbgroup];?>&mystatus=<?php echo $_REQUEST['mystatus'];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
                    <td width="36" align="center" valign="middle"><a href="ped_print.php?cmbgroup=<?php echo $_REQUEST[cmbgroup];?>&mystatus=<?php echo $_REQUEST['mystatus'];?>" target="_blank">                  
                      <img src="../images/print.png" alt="" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"></a></td>
                    </tr>
                  </table>
                <?php //} ?>
                </td>
            ...
            <tr>
              <td colspan="2" align="left" valign="top" style="padding-left:5px;">
                ...
                <table width="250" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
                  ...
                  <tr>
                    <td height="25" align="left" bgcolor="#FFCB7D" class="pedtext"><?php echo ADMIN_WEEK_MANAGE_STATUS ?> :</td>
                  ...
                  <tr>
                    <td height="25" align="left" bgcolor="#FFCB7D" class="pedtext"><?php echo ADMIN_NEWS_MANAGE_TEACHER ?> :</td>
      ...
      <tr>
        ...
        <form action="ped_process.php?action=insert" name="frm1" method="post" id="frm1">
          <table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 2px; border-color:#CC9900;">
            ...
            <tr>
              ...
              <?php //if($_REQUEST[cmbgroup]!='') { ?>
                    <table width="50%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="36" align="center" valign="middle"><a href="ped_word.php?cmbgroup=<?php echo $_REQUEST[cmbgroup];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
            ...
            <tr>
              <td align="center" valign="top" class="loginheading1"><?php echo constant("STUDENT_ADVISOR_PED_TNAME");?></td>
