                    ...
                    <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-left:solid 1px #C2C2C2; border-right:solid 1px #C2C2C2;  ">
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_S3_STDMOBNO");?><span class="nametext1">*</span> : </td>
                            <td>&nbsp;</td>
                          ...
                          <tr>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            <td height="28" align="right" valign="middle" class="leftmenu"><?php echo constant("STUDENT_ADVISOR_S3_TEXT3");?>: </td>
                            <td>&nbsp;</td>
                            <?php if($_SESSION[alt_no] == '') { $mobile1 = '009665'; } else { $mobile1 = $_SESSION[alt_no];}?>
                            <td width="23%" align="left" valign="middle" class="leftmenu"><input name="alt_no" type="text" class="new_textbox140" id="alt_no" value="<?php echo $mobile1;?>" onKeyPress="return PhoneNo(event);" maxlength="20" onBlur="checkTab('alt_no');"/></td>
                            </tr>
                          <tr>
                            <td align="left" valign="middle" class="leftmenu">&nbsp;</td>
                            <td height="28" align="left" valign="middle" class="leftmenu">&nbsp;</td>
                      ...
                      <tr>
					    ...
					    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td width="22%" align="left" valign="middle"><span class="leftmenu"><span class="nametext1">*</span> : <?php echo constant("STUDENT_ADVISOR_S3_STDMOBNO");?></span></td>
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td align="left" valign="middle"><span class="leftmenu"> : <?php echo constant("STUDENT_ADVISOR_S3_TEXT3");?></span></td>
