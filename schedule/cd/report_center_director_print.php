            ...
            <tr>
              ...
              <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="44%" height="20" align="left" valign="middle" class="leftmenu"><?php echo constant("TEACHER_REPORT_CENTERDI_HEADTEXT");?> : </td>
                        <td width="28%" align="left" valign="middle" class="content" style="border-bottom:dotted 1px #000000;"><?php echo $pro["report_print"];?></td>
                        <td width="28%">&nbsp;</td>
                      </tr>
                  </table></td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  ...
                  <td align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="44%" height="20" align="left" valign="middle" class="leftmenu"><?php echo constant("TEACHER_REPORT_CENTERDI_HEADTEXT");?> : </td>
                        <td width="28%" align="left" valign="middle" class="content" style="border-bottom:dotted 1px #000000;"><?php echo $pro["certificate_print"];?></td>
                        <td width="28%">&nbsp;</td>
                      </tr>
                  </table></td>
                  <td>&nbsp;</td>
