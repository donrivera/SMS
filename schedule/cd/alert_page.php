...
include_once '../includes/language.php';
	...
	color: #ccc;
		...
		<div style="width:575px;height:150px;" id="response">
			...
			<tr>
              ...
              <div class="pagination">
				<?php if($_POST['pagenumber']>0){?>
                    <a href="javascript:void(0);" class="red_smalltext" onclick="pagination('alert_page_ajax.php','<? echo $_POST['val']?>','<? echo $_POST['pagenumber']-1?>');"><< Prev</a>
                <?php }else{?>
                        <span class="red_smalltext">Prev</span>
                <?php } ?>
                <span class="forgottext">Page: <? echo $_POST['pagenumber']+1?>/<? echo $totalpage?></span>
				<?php if($totalpage >($_POST['pagenumber']+1)){ ?>
                        <a href="javascript:void(0);" class="red_smalltext"onclick="pagination('alert_page_ajax.php','<? echo $_POST['val']?>','<? echo $_POST['pagenumber']+1?>');">Next »</a>
                <?php } else{?>
                        <span class="red_smalltext">Next</span>
                <?php } ?>		
            </div>
              </td>
			</tr>
