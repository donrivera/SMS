		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td>&nbsp;</td>
                <td width="36" align="center" valign="top"><a href="centre_schedule_startdate_word.php?startdate=<?php echo $_REQUEST["startdate"];?>"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
                <td width="36" align="center" valign="top"><a href="centre_schedule_startdate_csv.php?startdate=<?php echo $_REQUEST["startdate"];?>"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_XLS ?>"></a></td>
                <td width="30" align="center" valign="top"><a href="centre_schedule_startdate_pdf.php?startdate=<?php echo $_REQUEST["startdate"];?>"><img src="../images/pdf.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_PDF ?>"></a></td>
