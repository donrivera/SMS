...
$filename = "centre_schedule_enddate_pdf.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."centre_schedule_enddate_pdf_data.php?enddate=$_REQUEST[enddate]&centre_id=$_SESSION[centre_id]&lang=$_SESSION[lang]";
