                          ...
                          <tr>
                            <td height="28" colspan="2" align="left" valign="top" class="leftmenu">
                              ...
                              <tr>
                                ...
                                <td align="left" valign="middle"><input type="text" name="gr_course_endt" class="validate[required] new_textbox80"  id="gr_course_endt" value="" readonly="" />&nbsp;<input type="text" name="dt" class="new_textbox80" id="dt" readonly="" value="">&nbsp;<input type="text" name="tm" class="new_textbox70" id="tm" readonly="" value=""></td>
                                </tr>
                              </table>
                            </td>
                            <td>&nbsp;</td>
                                          ...
                                          <td height="28" colspan="2" align="right" valign="top" class="leftmenu">
                                             <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              ...
                                              <tr>
                                                ...
                                                <tr>
                                                <td align="right" valign="middle"><input type="text" name="gr_course_endt" class="validate[required] new_textbox80_ar"  id="gr_course_endt" value="" readonly="" />&nbsp;<input type="text" name="dt" class="new_textbox80_ar" id="dt" readonly="" value="">&nbsp;<input type="text" name="tm" class="new_textbox70_ar" id="tm" readonly="" value=""></td>
