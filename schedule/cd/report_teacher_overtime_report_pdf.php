...
$htmlFile = $baseUrl."report_teacher_overtime_report_pdf_data.php?teacher=$_REQUEST[teacher]&start_date=$_REQUEST[start_date]&end_date=$_REQUEST[end_date]&centre_id=$_SESSION[centre_id]";
