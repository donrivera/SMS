                          ...
                          <tr class="mytext">
                            <td align="center" ><?php
                                  if($vali["paid_amt"]!="0") {
								  	...
								  	if($num_complete == 0) {
								  ?>
                                <a href="single-payment-edit.php?student_id=<?php echo $student_id;?>&amp;schid=<?php echo $vali["id"];?>&amp;course_id=<?php echo $course_id;?>"> <img src="../images/edit.gif" width="16" height="16" border="0" title="<?php echo EDIT?>" /></a>
                                <?php }} ?></td>
                            <td align="center" ><?php
                                  if($vali["paid_amt"]=="0") {
