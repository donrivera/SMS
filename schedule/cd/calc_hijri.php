...
<table width="420" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
  <tr>
    <td height="30" colspan="4" align="right" valign="middle" bgcolor="#CCCCCC" class="login_header">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_HIJRITOGREGORIAN");?></td>
  </tr>
  <tr>
    <td width="48">&nbsp;</td>
    <td width="59" height="20" align="left" valign="middle" class="bigerrortext">&nbsp;</td>
