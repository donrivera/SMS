...
<table width="420" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
  <tr>
    <td height="30" colspan="4" align="left" valign="middle" bgcolor="#CCCCCC" class="login_header">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_GREGORIANTOHIJRI");?></td>
  </tr>
  <tr>
    <td width="28">&nbsp;</td>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input name="dated" type="text" class="datepick textfield_amt" id="dated" readonly="readonly" /></td>
...
<table width="420" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc; margin-top:-15px;">
  <tr>
    <td height="40" colspan="4" align="right" valign="middle" bgcolor="#CCCCCC" class="login_header">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_GREGORIANTOHIJRI");?></td>
  </tr>
  <tr>
    <td width="28">&nbsp;</td>
    <td width="78" align="left" valign="middle" class="bigerrortext">&nbsp;</td>
