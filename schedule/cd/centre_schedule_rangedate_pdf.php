...
$filename = "centre_schedule_rangedate_pdf.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."centre_schedule_rangedate_pdf_data.php?startdate=$_REQUEST[startdate]&enddate=$_REQUEST[enddate]&centre_id=$_SESSION[centre_id]&lang=$_SESSION[lang]";
