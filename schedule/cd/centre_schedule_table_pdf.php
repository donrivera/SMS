...
$filename = "centre_schedule_table_pdf.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."centre_schedule_table_pdf_data.php?course=$_REQUEST[course]&centre_id=$_SESSION[centre_id]&lang=$_SESSION[lang]";
