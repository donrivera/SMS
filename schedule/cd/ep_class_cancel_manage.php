          ...
          <tr>
			...
			<thead>
              ...
              <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'">
                ...
                <td width="6%" align="center" valign="middle"><a href="ep_class_cancel_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onclick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>
                <?php
					  $i = $i + 1;
					  if($color=="#ECECFF")
					  {
              ...
              <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td  align="left" valign="top" bgcolor="#FFFFFF">
					...
					?>
                      <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'">
                        <td width="5%" align="center" valign="middle"><a href="ep_class_cancel_edit.php?id=<?php echo $val[id];?>"><img src="../images/edit.gif" width="16" height="16" border="0" title="<?php echo EDIT?>" /></a></td>
                        <td width="6%" align="center" valign="middle"><a href="ep_class_cancel_process.php?action=delete&amp;id=<?php echo $val[id];?>"  class="linktext" onclick="return confirm('Are you sure you want to delete this record ?')"><img src="../images/delete.png" width="16" height="16" border="0" title="<?php echo ACTION_CAPTION_DELETE ?>" /></a></td>                        
