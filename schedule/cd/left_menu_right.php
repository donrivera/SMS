...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	foreach($dbf->fetchOrder('quick_links',"module_name='Center Director' And user_id='$_SESSION[id]'","prec") as $val_quick)
	{
		...
		else if($val_quick[links]=="s_age.php"){ $linkname = constant("CD_MENU_WIZBASESTD");}
		else if($val_quick[links]=="student_manage.php"){ $linkname = constant("SA_MENU_QUICKADD");}
		else if($val_quick[links]=="s_classic.php"){ $linkname = constant("SA_MENU_CLASSIC");}
	...
	?>
      <tr>
        ...
        <td width="31" height="30" align="center" valign="middle"><?php //echo $val_quick[id];?><a href="<?php echo $val_quick[links];?>"><img src="<?php echo $img;?>" width="16" height="16" border="0" /></a></td>
      </tr>
      <tr>
