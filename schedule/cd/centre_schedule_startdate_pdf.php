...
$filename = "centre_schedule_startdate_pdf.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."centre_schedule_startdate_pdf_data.php?startdate=$_REQUEST[startdate]&centre_id=$_SESSION[centre_id]&lang=$_SESSION[lang]";
