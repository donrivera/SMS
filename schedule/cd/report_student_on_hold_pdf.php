...
$htmlFile = $baseUrl."report_student_on_hold_pdf_data.php?fname=$_REQUEST[fname]&stid=$_REQUEST[stid]&mobile=$_REQUEST[mobile]&email=$_REQUEST[email]&centre_id=$_SESSION[centre_id]";
