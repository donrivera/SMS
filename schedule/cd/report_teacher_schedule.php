		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="35%" height="30" align="left" class="logintext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_SCHEDULE");?></td>
                    ...
                    <tr>
                      <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                          ...
                          <td width="1%" align="left">&nbsp;</td>
                           <td width="35%" height="30" align="right" class="headingtext"><?php echo constant("ADMIN_MENU_REPORTS_SCHEDULE");?><img src="../images/arrow_small_right2.png" width="16" height="16"></td>
                          </tr>
                        </table></td>
                      </tr>
                    <tr>
