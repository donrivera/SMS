		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                <td width="30%" height="30" align="left" class="logintext">
				<img src="../images/rightarrow.png" width="16" height="16"><?php echo constant("ADMIN_MENU_REPORTS_TEACHER_OVER");?></td>
                <td width="6%" align="right" valign="middle" class="logintext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHER");?> :&nbsp; </td>
                ...
                <td width="5%" align="right" class="logintext"><?php //echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TO");?> &nbsp; </td>
                <td width="24%" align="left"><table width="180" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="100" align="center" valign="middle"><!--<input name="end_date" readonly="" type="text" class="datepick validate[required] new_textbox80" id="end_date" value="<?php //echo $_REQUEST[end_date];?>" size="45" minlength="4"/>--></td>
                    <td width="120" align="left" valign="middle" style="padding-left:5px;"><!--<input type="submit" name="submit" id="submit" value="<?php //echo constant("btn_search");?>" class="btn1" border="0" align="left" />--></td>
                  </tr>
                </table></td>
                    ...
                    <tr>
                      <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                        <tr class="logintext">
                          <td width="24%" align="left"><table width="180" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="120" align="left" valign="middle" style="padding-left:5px;"><!--<input type="submit" name="submit" id="submit" value="<?php //echo constant("btn_search");?>" class="btn2" border="0" align="left" />--></td>
                              <td width="100" align="center" valign="middle"><!--<input name="end_date" readonly="" type="text" class="datepick validate[required] new_textbox80_ar" id="end_date" value="<?php //echo $_REQUEST[end_date];?>" size="45" minlength="4"/>--></td>
