                                      ...
                                      <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                                        ...
                                        <tr>
                                          <td align="right" valign="middle">
                                            <input name="studentid" type="text" class="new_textbox190_ar" id="studentid" value="<?php echo $_SESSION[student_id];?>" onKeyPress="return PhoneNo(event);" maxlength="10" onBlur="checkTab('studentid');"/></td>
                                          <td>&nbsp;</td>
                                        ...
                                        <tr>
                                        <td align="right">
                                        <input type="submit" name="submit" id="submit" value="<?php echo constant("btn_next_btn");?>" class="btn2"/></td>
                                        <td align="left" valign="middle">&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <?php
										if($cid == '189'){
										...
										?>
                                          ...
                                          <a href="s1.php">
                                          <input type="button" value="<?php echo constant("btn_back");?>" class="btn1" border="0" align="left" /></a></td>                                          <td align="left" valign="middle" class="leftmenu">&nbsp;</td>                                          
                                          </tr>
                                        <tr>
                                          <td height="10" colspan="5" align="left" valign="middle"></td>
                                          </tr>
