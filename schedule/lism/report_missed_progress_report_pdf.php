...
$filename = "report_missed_progress_report.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."report_missed_progress_report_pdf_data.php?centre_id=$_REQUEST[centre_id]&teacher_id=$_REQUEST[teacher_id]";
