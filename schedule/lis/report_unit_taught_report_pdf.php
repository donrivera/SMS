...
$filename = "report_unit_taught_report.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."report_unit_taught_report_pdf_data.php?start_date=$_REQUEST[start_date]&end_date=$_REQUEST[end_date]";
