...
<table width="350" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#cccccc;">
  <tr>
    <td height="30" colspan="3" align="left" valign="middle" bgcolor="#CCCCCC" class="logintext">&nbsp;<?php echo constant("STUDENT_ADVISOR_CALC_CONVERTER_DATA_GREGORIANTOHIJRI");?>
</td>
  </tr>
  <tr>
    <td width="67" align="left" valign="middle" class="bigerrortext">&nbsp;</td>
    <td width="105">&nbsp;</td>
    <td width="176">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><input name="dated" type="text" class="datepick new_textbox100" id="dated" /></td>
