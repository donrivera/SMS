                  ...
                  <td colspan="3" align="center" valign="top">
                    <table width="80%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCCC99;">
                      ...
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="13%" rowspan="6" align="center" valign="middle"  style="border-right:solid #FF9900;border-bottom:solid #FF9900;"><img width="80" height="90" src="<?php echo $photo;?>" />
                            
                            </td>
                            <td width="75%" align="right" valign="middle" class="hometest_name"><?php echo $res["first_name"];?><?php echo $Arabic->en2ar($dbf->StudentName($res["id"]));?>&nbsp;</td>
                            <td width="12%" align="left" valign="middle" class="leftmenu">&nbsp; : <?php echo constant("STUDENT_MYACCOUNT_YOURNAME");?></td>
                            </tr>
                          <?php if($res["student_id"]>0) { ?>
                          <tr>
