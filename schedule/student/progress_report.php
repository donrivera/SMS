        ...
        <td colspan="3" align="left" valign="middle" bgcolor="#F2F2F2">
          ...
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" style="border:solid 1px; border-color:#000000;">
            ...
            <tr>
              ...
              <td align="left" valign="middle" bgcolor="#FFFFFF" class="pedtext_normal"><?php echo $res_student[first_name];?><?php echo $Arabic->en2ar($dbf->StudentName($res_student["id"]));?></td>
              <td bgcolor="#FFFFFF">&nbsp;</td>
            ...
            <tr>
              ...
              <td align="left" valign="middle" bgcolor="#FFFFFF" class="pedtext_normal"><?php echo $res_group[name];?></td>
              <td bgcolor="#FFFFFF">&nbsp;</td>
            ...
            <tr>
              ...
              <td align="left" valign="middle" bgcolor="#FFFFFF" class="pedtext_normal">
                <?php //echo "asd".$res_g[start_date];?>
			...
			?>
              <td align="left" valign="middle" bgcolor="#FFFFFF" class="pedtext_normal"><b><?php echo $num_att;?></b>&nbsp;&nbsp;&nbsp;<?php echo constant("CD_REPORT_TEACHER_PROGRESS_OUTOF");?>&nbsp;&nbsp;&nbsp;&nbsp;<b><?php echo $res_size[units];?></b></td>
              <td bgcolor="#FFFFFF">&nbsp;</td>
              <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
            ...
            <tr>
              ...
              <td align="left" valign="middle" bgcolor="#FFFFFF" class="pedtext_normal"><?php echo $res_course[name];?></td>
              <td bgcolor="#FFFFFF">&nbsp;</td>
              <td bgcolor="#FFFFFF">&nbsp;</td>
              <td bgcolor="#FFFFFF">&nbsp;</td>
              </tr>
            ...
            <tr>
              <td height="20" colspan="5" align="left" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><table width="985" border="0" cellspacing="0" cellpadding="0">
				...
				?>
                  <td align="center" valign="top" class="pedtext_normal">&nbsp;</td>
                ...
                <tr valign="top">
                  <td height="35" align="left" class="pedtext_normal">&nbsp;<?php echo constant("TEACHER_REPORT_TEACHER_COMPREHENSION");?></td>
