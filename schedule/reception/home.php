      ...
      <tr>
        ...
        <td width="79%" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 1px; border-color:#CCC;">
              <tr>
                ...
                <td width="47%" align="left" valign="middle" class="home_head_text"><table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                  <tr>
              ...
              <tr>
                ...
                ?>
                  ...
                  <tr>
                    <td><table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FFCC00;">
                        <tr>
...
<div id="dataDisplay">
  ...
  <table width="450" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td align="left" valign="top">&nbsp;</td>
                <td align="left" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#00CC00;">
                  <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:solid 1px; border-color:#CCC;">
              <tr>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#CCCCCC;">
                  ...
                  <tr>
                    <td width="25%" height="72" align="center" valign="middle">
                    <a href="home.php"><img src="../home_icon/home.jpg" width="80" height="63" border="0" /></a></td>
                    <td width="25%" align="center" valign="middle">
                    <a href="s_manage.php"><img src="../home_icon/student.jpg" width="70" height="60" border="0" /></a></td>
                    <td width="25%" align="center" valign="middle">
                    <a href="group_manage.php"><img src="../home_icon/group.jpg" width="60" height="60" border="0" /></a></td>
                    <td width="25%" align="center" valign="middle">
                    <a href="centre_schedule.php"><img src="../home_icon/center.jpg" width="60" height="56" border="0" /></a></td>
                    </tr>
                  <tr class="lable1">
                    <td height="30" align="center" valign="top">
                    <a href="home.php" title="<?php echo constant("ADMIN_MENU_HOME");?>"><span><?php echo constant("ADMIN_MENU_HOME");?></span></a></td>
                    <td align="center" valign="top">
                    <a href="s_manage.php" title="Student" rel=""><span><?php echo constant("ADMIN_NEWS_MANAGE_STUDENT");?></span></a></td>
                    <td align="center" valign="top">
                    <a href="group_manage.php" ><span><?php echo constant("ADMIN_REPORT_ABSENT_REPORT_GROUP");?></span></a></td>
                    <td align="center" valign="top">
                    <a href="centre_schedule.php" ><span><?php echo constant("RE_MENU_CS");?></span></a></td>
                  </tr>
                  <tr>
                    <td height="72" align="center" valign="middle">
                    <a href="password.php"><img src="../home_icon/chg_pass.png" width="60" height="60" border="0" /></a></td>
                    <td align="center" valign="middle">
                    <a href="calc_converter.php"><img src="../home_icon/calendar-icon.jpg" width="57" height="60" border="0" /></a></td>
                    <td align="center" valign="middle">
                    <a href="translate.php"><img src="../home_icon/converter_icon.jpg" width="60" height="60" border="0" /></a></td>
                    <td align="center" valign="middle">
                    <a href="student_appoint_manage.php"><img src="../home_icon/appoint.jpg" width="60" height="60" border="0" /></a></td>
                  </tr>
                  <tr class="lable1">
                    <td height="30" align="center" valign="top">
                    <a href="password.php" title="Certificates Grade"><span><?php echo constant("ADMIN_TEACHER1_MANAGE_PASSWORD");?></span></a></td>
                    <td align="center" valign="top">
                    <a href="calc_converter.php" title="Date Convertor"><span><?php echo constant("STUDENT_MENU_DATE_CONVERTER");?></span></a></td>
                    <td align="center" valign="top">
                    <a href="translate.php" title="Language Convertor"><span><?php echo constant("ADMIN_MENU_LANGUAGE_CONVERTER");?></span></a></td>
                    <td align="center" valign="top">
                    <a href="student_appoint_manage.php" title="Alerts"><span><?php echo constant("STUDENT_APPOINTMENT");?></span></a></td>
                  </tr>
                  <tr>
                    <td height="70" align="center" valign="middle"><a href="alert_page.php?choice=alert_respose&page=alert_page.php&amp;TB_iframe=true&amp;height=240&amp;width=465&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox "><img src="../home_icon/alert-icon.png" width="60" height="60" border="0" /></a></td>
                    <td align="center" valign="middle"><a href="sms.php"><img src="../home_icon/sms.jpg" width="60" height="60" border="0" /></a></td>
                  ...
                  <tr class="lable1">
                    <td height="30" align="center" valign="top">
                    <a href="alert_page.php?page=alert_page.php&amp;TB_iframe=true&amp;height=240&amp;width=465&amp;inlineId=hiddenModalContent&amp;modal=true" class="top_menu_link thickbox "><?php echo constant("ADMIN_MENU_ALERTS");?></a></td>
                    <td align="center" valign="top"><a href="sms.php" title="Leave"><span><?php echo constant("ADMIN_MENU_SMS");?></span></a></td>
                    <td align="center" valign="top"><a href="email.php"><?php echo constant("ADMIN_TEACHER1_MANAGE_EMAIL");?></a></td>
                    <td align="center" valign="top"><a href="quicklink_manage.php"><?php echo constant("ADMIN_MENU_QUICK_LINKS");?></a></td>
                    </tr>
                ...
                <table width="92%" border="0" cellspacing="0" cellpadding="0" style="border:solid 1px; border-color:#FF9900;">
                  <tr>
                          ...
                          <table width="450" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="382" align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td width="76%" align="right" valign="middle" class="hometest_time">
								  <?php echo date("l, M Y",strtotime($val["dt"]));?>&nbsp;,<?php echo $val["tm"];?></td>
                                ...
                                <tr>
                                  <td colspan="2" align="left" valign="top" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      ...
                                      <td width="5%" align="center" valign="middle" class="hometest_time">
                                ...
                                <?php } ?>
                                <tr>
                                  <td colspan="2" align="right" valign="top" class="hometest_time">
								  <?php echo $valm["name"];?> : <span class="hometest_name"><?php echo constant("RECEPTION_HOME_MSGTYPE");?></span></td>
                                </tr>
                                <tr>
                          ...
                          <?php
                            ...
                            ?>
                              <tr>
                                ...
                                <td width="351"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td width="71%" align="right" valign="middle" class="hometest_time">
									<?php echo date("l, d M Y",strtotime($val_r["date_time"]));?>&nbsp;,<?php echo date("h:i A",strtotime($val_r["date_time"]));?></td>
                                    <td width="29%" align="left" valign="middle" class="hometest_name">
									<?php echo constant("RECEPTION_HOME_POSTEDBY");?> <?php echo $res_user[user_name];?></td>
                                  </tr>
                                  <tr>
                                    <td height="5"></td>
                                    <td height="5"></td>
                              ...
                              <tr>
                                ...
                                <img src="../images/replyar.png" width="46" height="22" onclick="show_a(<?php echo $i;?>)" /></td>
                                </tr>
                              <tr>
                                <td height="10" colspan="3"><div id="diva<?php echo $i;?>" style="display:none;">
                                  <form action="home_process.php?action=insert&amp;row=<?php echo $i;?>" name="frma<?php echo $i;?>" method="post" id="frma<?php echo $i;?>" onsubmit="return validate(<?php echo $i;?>);">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="86%" align="left" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td width="30%" height="25" align="left" valign="middle" class="hometest_name"><input type="hidden" name="aid<?php echo $i;?>" id="aid<?php echo $i;?>" value="<?php echo $val[id];?>" /></td>
                                            <td width="58%" align="right" valign="middle" class="hometest_name"><?php echo $Arabic->en2ar('Reply Message');?>&nbsp;</td>
                                            </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td height="5" colspan="2" align="left" valign="middle" class="hometest_name"></td>
                                            </tr>
                                          <tr>
                                            <td align="left" valign="middle"><input type="image" src="../images/postar.png" width="46" height="22" /></td>
                                            <td>&nbsp;</td>
                                            </tr>
                                          </table></td>
                                        </tr>
              ...
              <tr>
                ...
                <td align="left" valign="top"><table width="450" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    ...
                    <td width="432" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="49%" align="left" valign="middle" class="hometest_name">
						<?php echo $vals["first_name"];?><?php echo $Arabic->en2ar($dbf->StudentName($vals["id"]));?></td>
                        <td width="51%" align="left" valign="middle" class="hometest_time"><?php echo date("d l, M Y",strtotime($val_s["dated"]));?></td>
                        </tr>
                      <tr>
                        <td height="5"></td>
