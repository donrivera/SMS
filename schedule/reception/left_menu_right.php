  ...
  <tr>
	...
	?>
      <tr>
        ...
        <td width="1291" align="right" valign="middle" class="<?php echo $class;?>"><a style="text-decoration:none;" href="<?php echo $val_quick[links];?>"><?php echo constant($linkname);?></a></td>
