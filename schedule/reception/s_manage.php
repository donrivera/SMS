    ...
    <td align="left" valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table height="36">
                    <tr>
                      <td width="66" height="36" align="left" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><?php echo constant("RECEPTION_SEARCH_FIRSTNAME");?></td>
                      <td width="158" height="36" align="left" valign="middle" bgcolor="#FFFFFF" ><input name="fname" type="text" class="new_textbox12" id="fname" value="<?php echo $_REQUEST[fname];?>"></td>
                      <td width="62" height="36" align="left" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><?php echo constant("RECEPTION_SEARCH_STUDENTID");?></td>
                      <td width="152" height="36" align="left" valign="middle" bgcolor="#FFFFFF"><input name="stid" type="text" class="new_textbox12" id="stid" value="<?php echo $_REQUEST[stid];?>" onKeyPress="return PhoneNo(event);"></td>
                      <td width="60" height="36" align="left" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><?php echo constant("RECEPTION_SEARCH_MOBILENO");?></td>
                      <td width="167" height="36" align="left" valign="middle" bgcolor="#FFFFFF"><input name="mobile" type="text" class="new_textbox12" id="mobile" value="<?php echo $_REQUEST[mobile];?>" onKeyPress="return PhoneNo(event);"></td>
                      <td width="32" height="36" align="left" valign="middle" bgcolor="#FFFFFF" class="leftmenu"><?php echo constant("RECEPTION_SEARCH_EMAIL");?></td>
                      <td width="153" height="36" align="left" valign="middle" bgcolor="#FFFFFF"><input name="email" type="text" class="new_textbox12" id="email" value="<?php echo $_REQUEST[email];?>"></td>
                      <td width="79" align="left" valign="middle" bgcolor="#FFFFFF"><input type="submit" name="submit" id="submit" value="<?php echo constant("btn_search");?>" class="btn1" border="0" align="left" /></td>
                    </tr>
                  </table></td>
          </tr>
          <tr>
