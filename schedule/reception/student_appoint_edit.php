                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" >
                          ...
                          <tr>
                            ...
                            <td align="left" valign="middle"><label for="comment"></label>
                              <textarea name="comment" id="comment" cols="45" rows="5" class="validate[required] mytext"><?php echo $res["comments"]; ?></textarea> </td>
                            <td>&nbsp;</td>
						  ...
						  ?>
		                      ...
		                      ?>
                                ...
                                <tr>                           
                                  ...
                                  <td>&nbsp;</td>
                                  <td align="right" valign="middle">
                                    <textarea name="comment" id="comment" cols="45" rows="5" class="validate[required] mytext" style="text-align:right;"><?php echo $res["comments"]; ?></textarea></td>
                                  <td>&nbsp;</td>
