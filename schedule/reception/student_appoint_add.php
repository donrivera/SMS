                          ...
                          <form action="student_appoint_process.php?action=insert" name="frm" method="post" id="frm">
                              <table width="109%" border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                  ...
                                  <td>&nbsp;</td>
                                  <td align="left" valign="middle">
                                  <textarea name="comment" id="comment" cols="45" rows="5" class="validate[required] mytext"></textarea></td>
                                ...
                                <tr>
                                  ...
                                  <td colspan="2" align="left" valign="middle"><table width="75%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                        ...
                                        <td width="70%" align="left" valign="middle" class="mycon" ><?php echo constant("CD_STUDENT_STATUS_STANDARD_SMS");?></td>
                                      </tr>
                                      <tr>
                                        <td align="center" valign="middle"><input name="sms" type="radio" id="radio5" value="2" onchange="showsms(this.value)" /></td>
                                        <td align="left" valign="middle" class="mycon"><?php echo constant("CD_STUDENT_STATUS_CANCEL_SMS");?></td>
                                      </tr>
                                      <tr>
                                        <td align="center" valign="middle"><input name="sms" type="radio" id="radio6" value="3" onchange="showsms(this.value)" /></td>
                                        <td align="left" valign="middle" class="mycon"><?php echo constant("CD_STUDENT_STATUS_CHANGE_SMS");?></td>
                                      </tr>
                                      <tr>
                            ...
                            <form action="student_appoint_process.php?action=insert" name="frm" method="post" id="frm">
                              <table width="109%" border="0" cellpadding="0" cellspacing="0" >
                                ...
                                <tr>
                                  <td align="left" valign="middle" id="lblcom">&nbsp;</td>
                                  <td align="right" valign="middle">
                                    <textarea name="comment" id="comment" cols="45" rows="5" class="validate[required] mytext" style="text-align:right;"></textarea></td>
                                  <td>&nbsp;</td>
                                ...
                                <tr>
                                  <td colspan="2" align="right" valign="middle"><table width="75%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td width="70%" align="right" valign="middle" class="mycon"><?php echo constant("CD_STUDENT_STATUS_STANDARD_SMS");?></td>
                                      <td width="5%" align="center" valign="middle">
									  <script language="JavaScript" type="text/javascript">
										function showsms(val){
											if(val == "3"){
                                    ...
                                    <tr>
                                      <td align="right" valign="middle" class="mycon"><?php echo constant("CD_STUDENT_STATUS_CANCEL_SMS");?></td>
                                      <td align="center" valign="middle"><input name="sms" type="radio" id="radio5" value="2" onchange="showsms(this.value)" /></td>
                                      </tr>
                                    <tr>
                                      <td align="right" valign="middle" class="mycon"><?php echo constant("CD_STUDENT_STATUS_CHANGE_SMS");?></td>
                                      <td align="center" valign="middle"><input name="sms" type="radio" id="radio6" value="3" onchange="showsms(this.value)" /></td>
                                      </tr>
                                    <tr>                                       
                                      <?php
