...
$filename = "report_sales_summary_report.pdf";

$filepath="pdf_reports/".$filename;

$fl = base64_encode($_REQUEST[radio]);

$htmlFile = $baseUrl."report_sales_summary_report_pdf_data.php?centre_id=$_REQUEST[centre_id]&start_date=$_REQUEST[start_date]&end_date=$_REQUEST[end_date]&radio=".$fl;
