...
$filename = "report_student_ledger_report.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."report_student_ledger_report_pdf_data.php?student_id=$_REQUEST[student_id]&start_date=$_REQUEST[start_date]&end_date=$_REQUEST[end_date]&balance=$_REQUEST[balance]";
