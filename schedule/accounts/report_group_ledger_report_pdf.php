...
$filename = "report_group_ledger_report.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."report_group_ledger_report_pdf_data.php?group_id=$_REQUEST[group_id]&start_date=$_REQUEST[start_date]&end_date=$_REQUEST[end_date]";
