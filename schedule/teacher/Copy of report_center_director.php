              ...
              <td colspan="4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <table width="250" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
                    ...
                    <tr>
                      <td width="70%" height="25" align="right" bgcolor="#FFCB7D" class="pedtext" id="statusresult"><select name="group_id" id="group_id" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
                            <option value="">Select Group</option>
                            <?php
							  if($_REQUEST["mystatus"] == ''){
								  $status = 'Continue';
                      ...
                      <td width="30%" align="left" valign="middle" bgcolor="#FFCB7D" class="pedtext" >: <?php echo constant("TEACHER_REPORT_TEACHER_GROUP");?></td>
                    </tr>
                    <?php
					$res_g = $dbf->strRecordID("student_group","*","id='$_REQUEST[group_id]'");
					$res_course = $dbf->strRecordID("course","*","id='$res_g[course_id]'");
                ...
                <tr>
                  <td height="20" colspan="2" align="right" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="21%" align="right" valign="middle" class="nametext">&nbsp;</td>
                      <td width="43%" align="right" valign="middle" class="nametext"><?php echo $rest[name];?>&nbsp;</td>
                      <td width="27%" align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_TEACHER");?></td>
                      <td width="9%">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" class="nametext">&nbsp;</td>
                      <td align="right" valign="middle" class="nametext"><?php echo constant("CD_REPORT_CENTER_DIRECTOR_HOUR");?> <?php echo $hr;?>&nbsp;</td>
                      <td align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_TXT6");?></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle">&nbsp;</td>
                      <td align="right" valign="middle" class="nametext" style="border-bottom:dotted 1px #000000;"><?php echo $pro["certificate"];?>&nbsp;</td>
                      <td align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_CERTIFICATE");?></td>
                      <td>&nbsp;</td>
                    </tr>
                  </table></td>
                  <td>&nbsp;</td>
                  <td align="right" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="49%" align="right" valign="middle" class="nametext" style="border-bottom:dotted 1px #000000;"><?php echo $res_size[units];?>&nbsp;</td>
                      <td width="45%" align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_TXT5");?></td>
                      <td width="6%">&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" class="nametext">&nbsp;</td>
                      <td align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_GROUPSTDT");?></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" class="nametext">&nbsp;</td>
                      <td align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_GROUPENDDT");?></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" class="nametext">&nbsp;</td>
                      <td align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_PROGRESSREPORT");?></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" class="nametext">&nbsp;</td>
                      <td align="left" valign="middle" class="nametext">&nbsp;: <?php echo constant("TEACHER_REPORT_TEACHER_BY");?></td>
                      <td>&nbsp;</td>
                    </tr>
                    <tr>
                      <td align="right" valign="middle" class="nametext">&nbsp;</td>
