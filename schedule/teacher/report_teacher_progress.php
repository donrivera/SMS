...
<table <?php if($_SESSION["lang"] == "AR"){?> style="margin-top:-15px;" <?php } ?> width="100%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="countdown_init(<?=$count;?>);">
  ...
  <tr>
    ...
    <form action="report_teacher_progress_save.php?action=insert" name="frm" method="post" id="frm">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:solid 2px; border-color:#CC9900;">
          <tr>
            <td width="6%">&nbsp;</td>
            <td width="13%">&nbsp;</td>
            <td width="77%">&nbsp;</td>
              ...
              <tr>
                ...
                <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px; border-collapse:collapse;">
                  ...
                  <tr>
                    ...
                    <td width="9%" height="20" align="center" bgcolor="#E8E8E8" class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_STDNAT");?></td>
                    <td width="9%" height="20" align="center" bgcolor="#E8E8E8" class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_STDIDNO");?></td>
                    <td width="6%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_PARTICI");?></span></td>
                    <td width="6%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_HW");?></span></td>
                    <td width="6%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_FLUENCY");?></span></td>
                    <td width="7%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_PRONOUN");?></span></td>
                    <td width="7%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_GRAMMER");?></span></td>
                    <td width="6%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_VOCABU");?></span></td>
                    <td width="8%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_LISTCOMPREH");?></span></td>
					<td width="9%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_ATTEND");?></span></td>
                    <td width="7%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_TXT8");?></span></td>
                    <td width="8%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_TXT9");?></span></td>
                  </tr>
					<?php
					$student_count = 1;
                ...
                <tr>
				  ...
				  <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border:solid 1px; border-collapse:collapse;">
                    <tr>
                      ...
                      <td width="6%" height="20" align="center" bgcolor="#E8E8E8" class="nametext"><?php echo constant("TEACHER_REPORT_TEACHER_STDIDNO");?></td>
                      <td width="6%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_FLUENCY");?></span></td>
                      <td width="8%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_PRONOUN");?></span></td>
                      <td width="6%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_GRAMMER");?></span></td>
                      <td width="8%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_VOCABU");?></span></td>
                      <td width="8%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_LISTCOMPREH");?></span></td>
                      <td width="8%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_TEXT");?></span></td>
                      <td width="8%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_ATTEND");?></span></td>
                      <td width="9%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_TXT8");?></span></td>
                      <td width="10%" height="20" align="center" class="rotate_text"><span class="pedtext"><?php echo constant("TEACHER_REPORT_TEACHER_TXT9");?></span></td>
                    </tr>
                    <tr>
                      <td height="25" align="left" valign="middle" bgcolor="#E8E8E8" class="smalltext">&nbsp;</td>
                      <td align="left" valign="middle" bgcolor="#E8E8E8" class="smalltext">&nbsp;</td>
  ...
  <tr>
    ...
    <form action="report_teacher_progress_save.php?action=insert" name="frm" method="post" id="frm">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:solid 2px; border-color:#CC9900;">
          ...
          <tr>
            <td>&nbsp;</td>
            <td align="left" valign="top"><?php if($_REQUEST[group_id]!='') {?>
            <a href="report_teacher_progress_print.php?group_id=<?php echo $_REQUEST[group_id];?>" target="_blank">
            <img src="../images/print.png" width="16" height="16" /></a><?php } ?></td>
            <td align="center" valign="middle" class="heading1"><?php echo constant("TEACHER_REPORT_TEACHER_HEADTEXT");?></td>
            <td align="left" valign="middle" class="heading">
            ...
            <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  ...
                  <table width="250" border="0" cellspacing="0" cellpadding="0" style="border:solid 2px; border-color:#993030;">
                    ...
                    <tr>
                      <td width="65%" height="25" align="right" bgcolor="#FFCB7D" id="statusresult"><select name="group_id" id="group_id" style="width:150px; border:solid 1px; border-color:#999999;" onChange="setsubmit();">
                          <option value="">Select Group</option>
                          <?php
						  if($_REQUEST["mystatus"] == ''){
							  $status = '';
                      ...
                      <td width="35%" align="left" valign="middle" bgcolor="#FFCB7D" class="pedtext">: <?php echo constant("TEACHER_REPORT_TEACHER_GROUP");?>
