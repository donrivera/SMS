...
if($_SERVER['HTTP_HOST'] == "bletprojects.com" || $_SERVER['HTTP_HOST'] == "localhost"){
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/schedule/teacher/"; 
}else if($_SERVER['HTTP_HOST'] == "berlitz-ksa.com" || $_SERVER['HTTP_HOST'] == "www.berlitz-ksa.com"){
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/mySMS/teacher/"; 
}else{
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/teacher/";
} 

$filename = "report_group_to_finish.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."report_group_to_finish_pdf_data.php?start_date=$_REQUEST[start_date]&end_date=$_REQUEST[end_date]";
