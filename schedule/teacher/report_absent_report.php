...
<table <?php if($_SESSION["lang"] == "AR"){?> style="margin-top:-15px;" <?php } ?> width="100%" border="0" align="center" cellpadding="0" cellspacing="0" onClick="countdown_init(<?=$count;?>);">
  ...
  <tr>
    <td align="left" height="25" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td>&nbsp;</td>
          <td width="36" align="center" valign="middle"><a href="report_absent_report_word.php"><img src="../images/word2007.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_WORD ?>"></a></td>
          <td width="36" align="center" valign="middle"><a href="report_absent_report_csv.php"><img src="../images/excel2007.PNG" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_XLS ?>"></a></td>
          <td width="36" align="center" valign="middle"><a href="report_absent_report_pdf.php"><img src="../images/pdf.png" width="20" height="20" border="0" title="<?php echo ICON_EXPORT_PDF ?>"></a></td>
          <td width="36" align="center" valign="middle"><a href="report_absent_report_print.php" target="_blank"><img src="../images/print.png" width="16" height="16" border="0" title="<?php echo STUDENT_ADVISOR_SEARCH_MANAGE_PRINT ?>"></a></td>
        </tr>
      </table></td>
      </tr>
  <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  <td width="39%" height="30" class="headingtext"><img src="../images/rightarrow.png" width="16" height="16"><?php echo 

constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?> <img src="../images/rightarrow.png" width="16" height="16"> <?php echo constant("ADMIN_REPORT_ABSENT_REPORT_ABSENTREPORT");?> </td>
          ...
          <tr>
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB"class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr bgcolor="<?php echo $color;?>" onMouseover="this.bgColor='#FDE6D0'" onMouseout="this.bgColor='<?php echo $color;?>'" style="cursor:pointer;">
                  ...
                  <td align="left" valign="middle" class="contenttext" style="padding-left:5px;"><?php echo $res[first_name];?> <?php echo $Arabic->en2ar($dbf->StudentName($res["id"]));?></td>
          ...
          <tr>
            <td align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
                <tr class="logintext">
                  ...
                  <td width="35%" align="right" class="headingtext"><?php echo 

constant("ADMIN_REPORT_TEACHER_BOARD_PROGRESSREPORTS");?><img src="../images/arrow_small_right2.png" width="16" height="16"> <?php echo constant("ADMIN_REPORT_ABSENT_REPORT_ABSENTREPORT");?><img src="../images/arrow_small_right2.png" width="16" height="16"> </td>
                </tr>
            </table></td>
          </tr>
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="0" cellspacing="0"  bordercolor="#DFF2DB"class="tablesorter" id="sort_table" style="border-collapse:collapse;">
                ...
                <tr class="logintext">
                  ...
                  <th width="12%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_TEACHER_BOARD_STUDENTNAME");?></span></th>
                  <th width="12%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_GROUP_TO_FINISH_LEVEL");?></span></th>
                  <th width="7%" height="30" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_ABSENT_REPORT_GROUP");?></span></th>
                  <th width="13%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_ABSENT_REPORT_TEACHERNAME");?></span></th>
                  <th width="15%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_ABSENT_REPORT_MOBILENO");?></span></th>
                  <th width="17%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_ABSENT_REPORT_EMAILADDRESS");?></span></th>
                  <th width="11%" align="left" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_ABSENT_REPORT_LASTATTAND");?></span></th>
                  <th colspan="2" align="center" valign="middle" bgcolor="#99CC99" class="menutext"><span class="pedtext"><?php echo constant("ADMIN_REPORT_ABSENT_REPORT_TOTALABSENT");?></span></th>
                  <th width="2%" height="25" align="center" valign="middle" bgcolor="#99CC99">&nbsp;</th>
                </tr>
				</thead>
                <?php
					...
					//loop start
					foreach($dbf->fetchOrder('student',"centre_id='$_SESSION[centre_id]'","first_name") as $val) {
