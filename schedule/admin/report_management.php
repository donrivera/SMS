            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <table width="60%" border="1" cellspacing="0" bordercolor="#CCCCCC" cellpadding="0" style="border-collapse:collapse;">
                  <tr>
                    <td width="6%">&nbsp;</td>
                    <td width="61%" height="25" align="right" valign="middle" class="lable1">Date :&nbsp;</td>
                    <td width="33%" align="center" valign="middle" class="pedtext"><?php echo $_REQUEST[start_date];?>&nbsp;/&nbsp;<?php echo $_REQUEST[end_date];?></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Count of interviews by appointments :&nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Count of interviews conducted :&nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of new enrollments :&nbsp;</td>
                    <?php
					//loop start
					$enroll = 0;
                  ...
                  <tr>
                    <td align="left">&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of re-enrollments :&nbsp;</td>
                    <?php
					//loop start
					$re_enroll = 0;
					foreach($dbf->fetchOrder('student_enroll', "(enroll_date BETWEEN '$start_date' And '$end_date') And centre_id='$centre_id'") as $valenroll) {					
                  ...
                  <tr>
                    <td width="6%">&nbsp;</td>
                    <td width="61%" height="25" align="right" valign="middle" class="lable1">&nbsp;Sum of number of new and re-enrollments :&nbsp;</td>
                    <td width="33%" align="center" valign="middle" class="pedtext"><?php echo $enroll+$re_enroll;?></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of certificates issued :&nbsp;</td>
                    <?php
					$no_of_certificat = 0;
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of progress reports issued :&nbsp;</td>
                    <?php
					$no_of_progress = 0;
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of students absent :&nbsp;</td>
                    <?php
					$no_of_attand = 0;
                  ...
                  <tr>
                    <td align="left">&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of students SMS'd (automatically by the system) :&nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td width="6%">&nbsp;</td>
                    <td width="61%" height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of students cancelled :&nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of students transferred :&nbsp;</td>
                    <td align="center" valign="middle" class="pedtext">&nbsp;</td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of new groups started &nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of groups completed :&nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td align="left">&nbsp;</td>
                    <td height="25" align="right" valign="top" class="lable1">&nbsp;Sum of total sales :&nbsp;</td>
                  ...
                  <tr>
                    <td width="6%">&nbsp;</td>
                    <td width="61%" height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of teaching units :&nbsp;</td>
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of SMS sent :&nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of emails sent :&nbsp;</td>
                    <?php
                  ...
                  <tr>
                    <td>&nbsp;</td>
                    <td height="25" align="right" valign="middle" class="lable1">&nbsp;Total number of ARF logged :&nbsp;</td>
                    <?php
