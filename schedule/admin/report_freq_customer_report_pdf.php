...
if($_SERVER['HTTP_HOST'] == "bletprojects.com" || $_SERVER['HTTP_HOST'] == "localhost"){
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/schedule/admin/"; 
}else if($_SERVER['HTTP_HOST'] == "berlitz-ksa.com" || $_SERVER['HTTP_HOST'] == "www.berlitz-ksa.com"){
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/mySMS/admin/"; 
}else{
	$baseUrl="http://" . $_SERVER['HTTP_HOST'] ."/admin/";
}  

$filename = "report_freq_customer_report.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."report_freq_customer_report_pdf_data.php?fname=$_REQUEST[fname]&stid=$_REQUEST[stid]&mobile=$_REQUEST[mobile]&email=$_REQUEST[email]";
