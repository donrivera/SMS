...
$filename = "report_management.pdf";

$filepath="pdf_reports/".$filename;
$htmlFile = $baseUrl."report_management_pdf_data.php?centre_id=$_REQUEST[centre_id]&start_date=$_REQUEST[start_date]&end_date=$_REQUEST[end_date]";
