          ...
          <tr>
            <td height="450" align="left" valign="top"  style="border:solid 1px; border-color:#CCC; background-color:#FFF;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <table width="99%" border="1" cellspacing="0" bordercolor="#333333" cellpadding="0" style="border-collapse:collapse;" >
                  <tr>
                    <td width="10%" align="left" valign="middle" bgcolor="#333333">&nbsp;</td>
                    <td width="40%" align="left" valign="middle" bgcolor="#333333" class="logintext"><?php echo constant("ADMIN_DASHBOARD_STUDENT");?></td>
                    <td width="25%" align="center" valign="middle" bgcolor="#333333" class="logintext"><?php echo constant("ADMIN_DASHBOARD_DATED");?></td>
                    <td width="25%" height="25" align="right" valign="middle" bgcolor="#333333" class="logintext"><?php echo constant("ADMIN_DASHBOARD_AMOUNT");?>&nbsp;</td>
                  </tr>
                  <?php
				...
				?></td>
                <td>&nbsp;</td>
                <td align="center" valign="top"><table width="99%" border="1" cellspacing="0" bordercolor="#666666" cellpadding="0" style="border-collapse:collapse;" >
                  <tr>
                    <td width="12%" height="25" align="left" valign="middle" bgcolor="#666666">&nbsp;</td>
                    <td width="38%" align="left" valign="middle" bgcolor="#666666" class="logintext"><?php echo constant("ADMIN_DASHBOARD_STUDENT");?></td>
                    <td width="50%" align="center" valign="middle" bgcolor="#666666" class="logintext"><?php echo constant("ADMIN_DASHBOARD_DATED_TIME");?></td>
                  </tr>
                  <?php
                ...
                <table width="100%" border="1" cellspacing="0" bordercolor="#666666" cellpadding="0" style="border-collapse:collapse;" >
                  <tr>
                    ...
                    <?php
						...
						$res=$dbf->strRecordID('student', 'COUNT(id)',"created_datetime BETWEEN '$start_date' AND '$end_date'");
