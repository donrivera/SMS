          ...
          <tr>
            <td height="0" align="left" valign="middle" bgcolor="#b4b4b4" class="title headingtext" style="background:url(../images/footer_repeat.png) repeat-x;"><table width="100%" border="0" cellspacing="0">
              <tr class="logintext">
                ...
                <td width="9%" align="right" valign="middle" class="headingtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TEACHER");?> : </td>
                ...
                <td width="6%" align="right" class="headingtext"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_FROM");?> : </td>
                ...
                <td width="2%" align="center"><?php echo constant("ADMIN_REPORT_TEACHER_LEAVE_REPORT_TO");?> : </td>
                <td width="24%" align="left"><table width="230" border="0" cellspacing="0" cellpadding="0">
                  <tr>
